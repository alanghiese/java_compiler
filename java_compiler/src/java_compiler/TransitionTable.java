...
public class TransitionTable {
	...
	public TransitionTable(){
		...
		mas[0][0]=as;   mas[0][1]=as;    mas[0][2]=as;    mas[0][3]=as;    mas[0][4]=as; 
                ...
                mas[1][5]=as;    mas[1][6]=asErr;   mas[1][7]=asErr; mas[1][8]=asErr;	mas[1][9]=asErr;
                mas[1][10]=asErr; mas[1][11]=asErr; mas[1][12]=asErr;  mas[1][13]=asErr; mas[1][14]=asErr;
                mas[1][15]=asErr; mas[1][16]=asErr; mas[1][17]=asErr;	mas[1][18]=asErr; mas[1][19]=asErr;
                mas[1][20]=asErr; mas[1][21]=asErr; mas[1][22]=asErr;	mas[1][23]=asErr; mas[1][24]=asErr;
                mas[1][25]=asErr; mas[1][26]=asErr;	
                
                mas[2][0]=as1;   mas[2][1]=as;      mas[2][2]=as;    mas[2][3]=as;	mas[2][4]=as;
                mas[2][5]=as;    mas[2][6]=as1;     mas[2][7]=as1;   mas[2][8]=as1;	mas[2][9]=as1;
                mas[2][10]=as1;  mas[2][11]=as1;    mas[2][12]=as1;  mas[2][13]=as1;	mas[2][14]=as1;
                mas[2][15]=as1; mas[2][16]=as1;    mas[2][17]=as1;  mas[2][18]=as1;	mas[2][19]=as1;
                mas[2][20]=as1; mas[2][21]=as1;    mas[2][22]=as1;  mas[2][23]=as1;	mas[2][24]=as1;
                mas[2][25]=asErr; mas[2][26]=as1;	
                
                mas[3][0]=as;    mas[3][1]=asErr;	mas[3][2]=asErr; mas[3][3]=asErr;	mas[3][4]=asErr;
                mas[3][5]=as;    mas[3][6]=asErr;	mas[3][7]=asErr; mas[3][8]=asErr;	mas[3][9]=asErr;
                mas[3][10]=asErr; mas[3][11]=asErr; mas[3][12]=asErr;  mas[3][13]=asErr; mas[3][14]=asErr;
                mas[3][15]=asErr; mas[3][16]=asErr; mas[3][17]=asErr;	mas[3][18]=asErr; mas[3][19]=asErr;
                mas[3][20]=asErr; mas[3][21]=asErr; mas[3][22]=asErr;	mas[3][23]=asErr; mas[3][24]=asErr;
                mas[3][25]=asErr; mas[3][26]=asErr;	
                
                mas[4][0]=asErr; mas[4][1]=asErr; mas[4][2]=as;    mas[4][3]=asErr;	mas[4][4]=as2;
                mas[4][5]=as;    mas[4][6]=asErr;	mas[4][7]=asErr; mas[4][8]=asErr;	mas[4][9]=asErr;
                mas[4][10]=asErr; mas[4][11]=asErr; mas[4][12]=asErr; mas[4][13]=asErr; mas[4][14]=asErr;
                mas[4][15]=asErr; mas[4][16]=asErr; mas[4][17]=asErr; mas[4][18]=asErr; mas[4][19]=asErr;
                mas[4][20]=asErr; mas[4][21]=asErr; mas[4][22]=asErr; mas[4][23]=asErr; mas[4][24]=asErr;
                mas[4][25]=asErr; mas[4][26]=asErr;	
                
                mas[5][0]=asErr;  mas[5][1]=asErr; mas[5][2]=asErr; mas[5][3]=as2;	mas[5][4]=asErr;
                mas[5][5]=asErr;  mas[5][6]=asErr; mas[5][7]=asErr; mas[5][8]=asErr; mas[5][9]=asErr;
                mas[5][10]=asErr; mas[5][11]=asErr; mas[5][12]=asErr; mas[5][13]=asErr; mas[5][14]=asErr;
                mas[5][15]=asErr; mas[5][16]=asErr; mas[5][17]=asErr; mas[5][18]=asErr; mas[5][19]=asErr;
                mas[5][20]=asErr; mas[5][21]=asErr; mas[5][22]=asErr; mas[5][23]=asErr; mas[5][24]=asErr;
                mas[5][25]=asErr; mas[5][26]=asErr;	
                
                mas[6][0]=as3;   mas[6][1]=as;    mas[6][2]=as;    mas[6][3]=as;    mas[6][4]=as;
                mas[6][5]=as3;   mas[6][6]=as3;   mas[6][7]=as3;   mas[6][8]=as3;   mas[6][9]=as3;
                mas[6][10]=as3;  mas[6][11]=as3;  mas[6][12]=as3;  mas[6][13]=as3;  mas[6][14]=as3;
                mas[6][15]=as3;  mas[6][16]=as3;  mas[6][17]=as3;  mas[6][18]=as3;  mas[6][19]=as3;
                ...
                mas[8][10]=as3;  mas[8][11]=as;	mas[8][12]=as3;  mas[8][13]=as3;	mas[8][14]=as3;
                mas[8][15]=as3;  mas[8][16]=as3;	mas[8][17]=as3;  mas[8][18]=as3;	mas[8][19]=as3;
                mas[8][20]=as3;  mas[8][21]=as3;	mas[8][22]=as3;  mas[8][23]=as3;	mas[8][24]=as3;
                mas[8][25]=asErr; mas[8][26]=as3;	
                
                mas[9][0]=as3;   mas[9][1]=as3;	mas[9][2]=as3;   mas[9][3]=as3;	mas[9][4]=as3;
                mas[9][5]=as3;   mas[9][6]=as3;	mas[9][7]=as3;   mas[9][8]=as3;	mas[9][9]=as3;
                mas[9][10]=as3;  mas[9][11]=as3;	mas[9][12]=as3;  mas[9][13]=as3;	mas[9][14]=as3;
                mas[9][15]=as3;  mas[9][16]=as3;	mas[9][17]=as3;  mas[9][18]=as3;	mas[9][19]=as3;
                mas[9][20]=as3;  mas[9][21]=as3;	mas[9][22]=as3;  mas[9][23]=as3;	mas[9][24]=as3;
                mas[9][25]=asErr; mas[9][26]=as3;	
                
                mas[10][0]=as3;  mas[10][1]=as3;	mas[10][2]=as3;  mas[10][3]=as3;	mas[10][4]=as3;
                mas[10][5]=as3;  mas[10][6]=as3;	mas[10][7]=as3;  mas[10][8]=as3;	mas[10][9]=as3;
                mas[10][10]=as3; mas[10][11]=as;	mas[10][12]=as3; mas[10][13]=as3;	mas[10][14]=as3;
                mas[10][15]=as3; mas[10][16]=as3;	mas[10][17]=as3; mas[10][18]=as3;	mas[10][19]=as3;
                mas[10][20]=as3; mas[10][21]=as3;	mas[10][22]=as3; mas[10][23]=as3;	mas[10][24]=as3;
                mas[10][25]=asErr; mas[10][26]=as3;	
                
                mas[11][0]=asErr; mas[11][1]=asErr; mas[11][2]=asErr; mas[11][3]=asErr; mas[11][4]=asErr;
                mas[11][5]=asErr; mas[11][6]=asErr; mas[11][7]=asErr; mas[11][8]=asErr; mas[11][9]=asErr;
                mas[11][10]=asErr; mas[11][11]=as; mas[11][12]=asErr; mas[11][13]=asErr; mas[11][14]=asErr;
                mas[11][15]=asErr; mas[11][16]=asErr; mas[11][17]=asErr; mas[11][18]=asErr;	mas[11][19]=asErr;
                mas[11][20]=asErr; mas[11][21]=asErr; mas[11][22]=asErr; mas[11][23]=asErr;	mas[11][24]=asErr;
                mas[11][25]=asErr; mas[11][26]=asErr;	
                
                mas[12][0]=asErr; mas[12][1]=asErr; mas[12][2]=asErr; mas[12][3]=asErr; mas[12][4]=asErr;
                mas[12][5]=asErr; mas[12][6]=asErr; mas[12][7]=asErr; mas[12][8]=asErr; mas[12][9]=asErr;
                mas[12][10]=asErr; mas[12][11]=as;  mas[12][12]=asErr; mas[12][13]=asErr; mas[12][14]=asErr;
                mas[12][15]=asErr; mas[12][16]=asErr; mas[12][17]=asErr; mas[12][18]=asErr;	mas[12][19]=asErr;
                mas[12][20]=asErr; mas[12][21]=asErr; mas[12][22]=asErr; mas[12][23]=asErr;	mas[12][24]=asErr;
                mas[12][25]=asErr; mas[12][26]=asErr;
                                
                mas[13][0]=as;   mas[13][1]=as;   mas[13][2]=as;   mas[13][3]=as;   mas[13][4]=as;
                mas[13][5]=as;   mas[13][6]=as;	mas[13][7]=as;   mas[13][8]=as;	mas[13][9]=as;
                mas[13][10]=as;  mas[13][11]=as;	mas[13][12]=as;  mas[13][13]=as;	mas[13][14]=as;
                mas[13][15]=as;  mas[13][16]=as5;	mas[13][17]=as;  mas[13][18]=as;	mas[13][19]=as;
                mas[13][20]=as;  mas[13][21]=as;	mas[13][22]=as;  mas[13][23]=asErr;   mas[13][24]=as;
                mas[13][25]=asErr;   mas[13][26]=as;
	}	
